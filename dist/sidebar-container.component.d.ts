...
export declare class SidebarContainer implements AfterContentInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SidebarContainer, "ng-sidebar-container", never, { "animate": { "alias": "animate"; "required": false; }; "allowSidebarBackdropControl": { "alias": "allowSidebarBackdropControl"; "required": false; }; "showBackdrop": { "alias": "showBackdrop"; "required": false; }; "contentClass": { "alias": "contentClass"; "required": false; }; "backdropClass": { "alias": "backdropClass"; "required": false; }; }, { "showBackdropChange": "showBackdropChange"; "onBackdropClicked": "onBackdropClicked"; }, never, ["ng-sidebar,[ng-sidebar]", "[ng-sidebar-content]"], true, never>;
}
